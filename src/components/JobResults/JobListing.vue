<template>
  <li class="mb-7">
    <router-link
      :to="jobPageLink"
      class="border-brand-gray hover:box-shaad mx-auto block rounded border border-solid border-brand-gray-2 bg-white hover:shadow-gray"
    >
